...
cx_Freeze.setup(
    name = "File Sorting Application | By Devansh",
    options = {"build_exe": {"packages":["tkinter","os","ttk","filedialog","messagebox","shutil"], "include_files":["icon.ico",'tcl86t.dll','tk86t.dll', 'icons2']}},
    version = "0.01",
